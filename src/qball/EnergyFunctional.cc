...
EnergyFunctional::EnergyFunctional( Sample& s, const Wavefunction& wf, ChargeDensity& cd)
  ...
  //not_pbe0= true;
  //if (s_.ctrl.xc=="PBE0") not_pbe0=false;
  ...
  if (s_.ctrl.tddft_involved)
  {
     ...
     if (not_hartree_fock) 
     {
        xcp_ = new XCPotential((*hamil_cd_),s_.ctrl.xc,cd_,s_);
  ...
  {  
     if (not_hartree_fock)  
     {
        xcp_ = new XCPotential(cd_,s_.ctrl.xc,s_);
        s_.ctrl.mgga = (xcp_->xcf()->ismGGA());
     }
  } 
  hf_pbe0=s_.ctrl.alpha_PBE0;
  ...
  if (s_.ctrl.xc=="B3LYP")  xop_= new ExchangeOperator(s_, 0.20, 0.20, 0.0);
...
void EnergyFunctional::update_vhxc(void) {
  ...
  if (s_.ctrl.xc=="PBE0" || s_.ctrl.xc=="RSH" || s_.ctrl.xc=="BHLYP"|| s_.ctrl.xc=="B3LYP")
  {
...
double EnergyFunctional::energy(Wavefunction& psi, bool compute_hpsi, Wavefunction& dwf,
  ...
  if ( compute_stress ) {
     ...
     if (s_.ctrl.xc=="HF" || s_.ctrl.xc=="PBE0" || s_.ctrl.xc=="RSH" || s_.ctrl.xc=="BHLYP" || s_.ctrl.xc=="B3LYP") xop_->add_stress(sigma_exc);
  }
  ...
  */
  ...
  if ( compute_hpsi ) {
    ...
    if (s_.ctrl.xc=="HF" || s_.ctrl.xc=="PBE0" || s_.ctrl.xc=="RSH" || s_.ctrl.xc=="BHLYP" || s_.ctrl.xc=="B3LYP") xop_->apply_operator(dwf);
